            ...
            <ul class="list-group">
                <?php foreach ($data['mhs'] as $mhs) : ?>
                    <li class="list-group-item">
                        <?= $mhs['nama']; ?>
                        <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('Yakin Mau Menghapusnya?');">delete</a>
                ...
                <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="jurusan" name="jurusan">
                            ...
                            <option value="Pendidikan TIK">Pendidikan TIK</option>
